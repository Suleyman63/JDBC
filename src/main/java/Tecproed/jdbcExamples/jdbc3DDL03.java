...
public class jdbc3DDL03 {
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		/*
		 * =============================================================================
		 * ==================== ORNEK1-) Isciler adinda bir tablo olusturunuz id
		 * NUMBER(3), birim VARCHAR2(10), maas NUMBER(5)
		 * =============================================================================
		 * ====================
		 */
		...
		// System.out.println("isciler tablosu olusturuldu" + st);

		// 2. YONTEM (executeUpdate() methodu ile)

		// st.executeUpdate(createQuery); // DDL islemleri 0 degerini dondurur.
		// System.out.println("isciler tablosu olusturuldu...." + st);
		...
		// System.out.println("isciler tablosuna isim sutun eklendi");

		/*
		 * =============================================================================
		 * =================== ORNEK4:isciler tablosuna soyisim VARCHAR2(20) ve sehir
		 * VARCHAR2(10)) adinda 2 yeni sutun ekleyiniz.
		 * =============================================================================
		 * =====================
		 */
		...
		// System.out.println("isciler tablosunda soyisim sutunu silindi");
		...
		// System.out.println("isciler tablosu calisanlar olarak degistirilmistir");
